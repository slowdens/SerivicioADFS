<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="ResultadoEva.aspx.cs" Inherits="ServicioBecario.Vistas.ResultadoEva" %>
   ...
   <link rel="stylesheet" href="../scripts/footable.bootstrap.min.css" type="text/css" /> 
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h4>Envío de correo de resultado de evaluaciones </h4>            
        </div>
    </div>
    <div class="jumbotron">
        <div class="row">
