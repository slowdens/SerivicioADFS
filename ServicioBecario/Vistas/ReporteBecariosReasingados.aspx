<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="ReporteBecariosReasingados.aspx.cs" Inherits="ServicioBecario.Vistas.ReporteBecariosReasingados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 text-center" >
            <h1><label>Reportes de becarios reasignados</label></h1>
            <hr />
        </div>
    </div>
    <div class="jumbotron">
        <div class="row">
            <div class="col-md-12 text-center">
                <fieldset >
                    <legend class="text-center"> <label>Filtros</label> </legend>
                </fieldset>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:DropDownList  ID="ddlCampus" runat="server" CssClass="form-control" OnDataBound="ddlCampus_DataBound"></asp:DropDownList>
            </div>
        </div>
        <div class="row">
            <div class="col-md-1">
                <asp:Button runat="server" ID="btnFiltrar" CssClass="btn btn-primary" Text="Filtro" OnClick="btnFiltrar_Click"/>
            </div>
            <div class="col-md-1">
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" AllowPaging="true" PageSize="10" runat="server" CssClass="table" AutoGenerateColumns="False"  CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvDatos_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Becario" HeaderText="Becario" SortExpression="Becario" ItemStyle-CssClass="text-center"  HeaderStyle-CssClass="text-center" ></asp:BoundField>
                                <asp:BoundField DataField="Deasocio" HeaderText="Deasocio" SortExpression="Deasocio" ItemStyle-CssClass="text-center"  HeaderStyle-CssClass="text-center" ></asp:BoundField>
