<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="SbNoEvaluados.aspx.cs" Inherits="ServicioBecario.Vistas.SbNoEvaluados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1><label> Reportes de Solicitantes no evaluados </label></h1>
            <hr />
        </div>        
    </div>
    <div class="jumbotron">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:DropDownList  ID="ddlFiltrarCampus" runat="server" CssClass="form-control" OnDataBound="ddlFiltrarCampus_DataBound" ></asp:DropDownList>
            </div>            
        </div>
        <div class="row">
            <div class="col-md-1">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
            <asp:Panel ID="pnlGrid" runat="server" CssClass="hscrollbar">
                <asp:UpdatePanel ID="UpdatePanelDatos" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" CssClass="table" AllowPaging="true" PageSize="10"  runat="server" AutoGenerateColumns="false" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvDatos_PageIndexChanging">
                            <AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
                            <Columns>
                                <asp:BoundField DataField="Nomina" HeaderText="Nomina" SortExpression="Nomina" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                <asp:BoundField DataField="Solicitante" HeaderText="Solicitante" SortExpression="Solicitante" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ></asp:BoundField>
                                ...
                                <asp:BoundField DataField="Nivel_academico" HeaderText="Nivel academico" SortExpression="Nivel_academico" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ></asp:BoundField>
