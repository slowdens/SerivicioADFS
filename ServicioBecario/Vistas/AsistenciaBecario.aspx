<%@ Page Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeBehind="AsistenciaBecario.aspx.cs" Inherits="ServicioBecario.Vistas.AsistenciaBecario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="jumbotron">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <label class="control-label"><em>Correo</em></label>
                    </div>
                    <div class="col-md-3">
                        <asp:Label ID="LblEmail" runat="server" Text="neftalitorres@itesm.mx"></asp:Label>
                    </div>
                </div>
                <div class="row" >
                    <div class="col-md-1 " ></div>
                    <div class="col-md-2 " >
                        <label for="Departamento" class="control-label"><em>Campus</em></label>
                    </div>
                    <div class="col-md-3 " >
                        <asp:Label ID="DatosCampus" runat="server" Text="Label" CssClass="control-label">Datos del campus</asp:Label>
                    </div>
                    <div class="col-md-2 " >
                        <label for="DatosCampus" class="control-label"><em>División</em></label>
                    </div>
                    <div class="col-md-3 " >
            ...
            <div class="col-md-12 center-block">
                    ...
                    <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                        <columns>
                            ...
                            <asp:buttonfield buttontype="Image" commandname="Asistencia" text="Asistencia" HeaderText="Asistencia" ImageUrl="~/images/00 banco de íconos-94-32.png" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"/>
                            <asp:buttonfield buttontype="Image" commandname="Detalle" text="Detalle" HeaderText="Detalle" ImageUrl="~/images/Detalle.png" HeaderStyle-CssClass="text-center" ItemStyle-HorizontalAlign="Center"/>
                        </columns>
                    </asp:GridView>
            </div>
        </div>
    ...
    <div class="row center-block">
        <div class="col-md-12 center-block">
            <asp:GridView ID="GrdBecario" ShowHeaderWhenEmpty="True" runat="server" AllowPaging="True" OnRowDataBound="GrdBecario_RowDataBound"
                BorderStyle="Solid" BorderWidth="0px" CellPadding="4" ForeColor="#333333" 
                GridLines="None"  CssClass="table" Width="70%" HorizontalAlign="Center" HeaderStyle-CssClass="text-center"  HeaderStyle-HorizontalAlign="Center">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775"/>
	            <EditRowStyle BackColor="#999999" /> 
			    <FooterStyle BackColor="#3B83C0" Font-Bold="True" ForeColor="White" CssClass="letra" />
                <HeaderStyle BackColor="#3B83C0" Font-Bold="True" ForeColor="White" CssClass="letra" />
    ...
    <div class="row center-block text-center">
        <div class="col-md-12 center-block text-center">
            <asp:Button ID="BtnGuardarAsistencia" runat="server" Text="Guardar Asistencia" CssClass="btn btn-primary" width="150px" OnClick="BtnGuardarAsistencia_Click" Visible="false"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="BtnGuardarAsistenciaG" runat="server" Text="Guardar Asistencia" CssClass="btn btn-primary" width="150px" OnClick="BtnGuardarAsistenciaG_Click"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="BtnRegresar1" runat="server" Text="Regresar" CssClass="btn btn-primary" width="150px" OnClick="BtnRegresar1_Click"/>
        </div>
    </div>
        <div class="row"><div class="col-md-12 " >&nbsp;</div></div>
    <div class="row center-block text-center">
