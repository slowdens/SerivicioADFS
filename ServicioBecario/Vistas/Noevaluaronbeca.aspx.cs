...
{
    public partial class Noevaluaronbeca : System.Web.UI.Page
    {
        ...
        {
            ddlFiltrarCampus.Items.Insert(0, new ListItem("-- Seleccione --", ""));
        }
                ...
                html = @"<table border='0'>
                            <tr>
                                <td colspan='6' style='text-align:center;font-size:20px;color:#113FB9'>
                                    REPORTE DE BECARIOS QUE NO HAN EVALUADO A SOLICITANTES
                                </td>
                            <tr>";
        ...
        public void llenarGrid()
        {
           ...
           {
               if (ddlNivel.SelectedItem.Text != "--Seleccione--")
               {
                   query = "sp_reporte_no_evaluaron_solicitante '" + ddlFiltrarCampus.SelectedValue + "','" + ddlFiltrarPeriodo.SelectedValue + "'," + ddlNivel.SelectedValue;
               }
               else
               {
                   query = "sp_reporte_no_evaluaron_solicitante '" + ddlFiltrarCampus.SelectedValue + "','" + ddlFiltrarPeriodo.SelectedValue + "',NULL";
               }
           }
           else
           {
               if (ddlNivel.SelectedItem.Text != "--Seleccione--")
               {
                   query = "sp_reporte_no_evaluaron_solicitante '" + hdfMostrarId.Value + "','" + ddlFiltrarPeriodo.SelectedValue + "'," + ddlNivel.SelectedValue;
               }
               else
               {
                   query = "sp_reporte_no_evaluaron_solicitante '" + hdfMostrarId.Value + "','" + ddlFiltrarPeriodo.SelectedValue + "',NULL";
               }
           }
