<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="EnvioCorreoEvaluacion.aspx.cs" Inherits="ServicioBecario.Vistas.EnvioCorreoEvaluacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h4>Envío de correo de aviso de inicio de evaluaciones </h4>            
        </div>
    </div>
    <div class="jumbotron">
        <div class="row">
