...
{
    public partial class Noevalubeca : System.Web.UI.Page
    {
        ...
        public void descarExcel(DataTable dts)
        {
            if (dts != null)
            {
                string attachment = "attachment; filename=No_evaluaron_becarios.xls";
                ...
                html = @"<table border='0'>
                            <tr>
                                <td colspan='6' style='text-align:center;font-size:20px;color:#113FB9'>
                                    REPORTE DE SOLICITANTES QUE NO EVALUARON A BECARIOS
                                </td>
                            <tr>";
        ...
        public void llenarGrid()
        {
            ...
            {
                query = "sp_reporte_no_evaluaron_becarios '" + ddlFiltrarCampus.SelectedValue + "','" + ddlFiltrarPeriodo.SelectedValue + "' ";
            }
            else
            {
                query = "sp_reporte_no_evaluaron_becarios '" + hdfMostrarId.Value + "','" + ddlFiltrarPeriodo.SelectedValue + "' ";
            }
