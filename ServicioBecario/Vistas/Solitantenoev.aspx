<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="Solitantenoev.aspx.cs" Inherits="ServicioBecario.Vistas.Solitantenoev" %>
            ...
            <asp:Panel ID="pnlGrid" runat="server" CssClass="hscrollbar">
                        <asp:GridView ID="gvDatos" CssClass="table" AllowPaging="true" PageSize="10"  runat="server" AutoGenerateColumns="false" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvDatos_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="NombreSolicitante" HeaderText="Solicitante" SortExpression="Solicitante" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ></asp:BoundField>                                
                                ...
                                <asp:BoundField DataField="Periodo" HeaderText="Periodo" SortExpression="Periodo" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ></asp:BoundField>                            </Columns>
