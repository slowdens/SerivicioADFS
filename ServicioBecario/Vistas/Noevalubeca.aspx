<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="Noevalubeca.aspx.cs" Inherits="ServicioBecario.Vistas.Noevalubeca" %>
   ...
   <script type="text/javascript">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
             <h4>No han evaluado becarios</h4>            
        </div>
    </div>
    <div class="jumbotron">
        <div class="row">
        ...
        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
            <asp:Panel ID="pnlGrid" runat="server" CssClass="hscrollbar">
                        ...
                        <asp:GridView ID="gvDatos" CssClass="table" AllowPaging="true" PageSize="20"  runat="server" AutoGenerateColumns="false" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvDatos_PageIndexChanging">
                            ...
                            <Columns>
                                <asp:BoundField DataField="Nomina" HeaderText="Nomina" SortExpression="Nomina" ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-left"></asp:BoundField>
                                <asp:BoundField DataField="NombreSolicitante" HeaderText="NombreSolicitante" SortExpression="NombreSolicitante" ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-left" ></asp:BoundField>
