<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="Mostrar.aspx.cs" Inherits="ServicioBecario.Vistas.Mostrar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button ID="Volver" runat="server" Text="Volver" CssClass="btn btn-primary btn-sm" OnClick="Volver_Click" />
        <div class="row">
        <div class="col-md-12">
                                ...
                                <asp:Panel ID="pnlVistaporProyecto" runat="server"  CssClass="hscrollbar">
                                    <asp:GridView ID="gvVistasProyecto" AutoGenerateColumns="false" CssClass="table" Width="100%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Eliminar"  ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="ImageButton1" Visible='<%# Convert.ToBoolean( Eval("Valor"))%>' CommandArgument='<%# Eval("id_consecutivo") %>' runat="server" ImageUrl="~/images/EliminarR.png" OnClick="btnporProyectoEliminar_Click" />
                                                    <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" DisplayModalPopupID="ModalPopupExtender1" TargetControlID="ImageButton1"></cc1:ConfirmButtonExtender>
                                                    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="Panel11" TargetControlID="ImageButton1"
                                                        OkControlID="btnYes" CancelControlID="btnNo" BackgroundCssClass="modalBackground1">
                                                    </cc1:ModalPopupExtender>
                                                    <asp:Panel ID="Panel11" runat="server" CssClass="modalPopup" Style="display: none">
                                                        ...
                                                        <div class="body">
                                                            <asp:Label ID="Label1" runat="server" Text="¿Desea eliminar el registro?"></asp:Label>
                                                        </div>
                                                        <div class="footer" align="right">
                                                            <asp:Button ID="Button1" runat="server" Text="Si" CssClass="yes" />
                                                            <asp:Button ID="Button2" runat="server" Text="No" CssClass="no" />
                                                        </div>
                                                    </asp:Panel>
                                                </ItemTemplate>
                                            </asp:TemplateField>
