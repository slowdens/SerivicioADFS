<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="Rol_menu_nuevo.aspx.cs" Inherits="ServicioBecario.Vistas.Rol_menu_nuevo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" >
        <div class="col-md-12 text-center">
            <h4 class="text-center">Asignación de rol a menú</h4>            
        </div>
    </div>
    ...
    <div class="jumbotron">
        <div class="row">
            ...
            <div class="col-md-3">
                <asp:DropDownList ID="DdlMenuPadre" AutoPostBack="true" runat="server" CssClass="form-control validate[required]"  OnDataBound="DdlPermisos_DataBound" OnSelectedIndexChanged="DdlMenuPadre_SelectedIndexChanged"></asp:DropDownList>
            </div>            
            <div class="col-md-1">
    ...
    <div>
        <asp:Panel ID="pnlgrid" runat="server" Visible="false">
                <div class="row table-condensed">
                    <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                        <asp:Panel runat="server" CssClass="hscrollbar" ID="pnlxdtos">
                            <asp:GridView ID="gvDatos" PageSize="20" AllowPaging="true" CssClass="table" DataKeyNames="id_menu" AutoGenerateColumns="false" Width="100%" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
                                <Columns>
                                    <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" DataField="id_menu" HeaderText="id_menu" SortExpression="id_menu" Visible="false" />
                                    ...
                                    <asp:TemplateField HeaderText="Agregar" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                        <ItemTemplate>
        ...
        <div id="ContBu">
    <asp:Panel ID="pnlvistaRolesMenu"  runat="server" Visible="false">
        <div class="jumbotron">
            <div class="row">
                <div class="col-md-12">
                    <fieldset>
                        <legend class="text-center">
                            <h4 class="text-center">Menús asignado a roles</h4>                                        
                        </legend>
                    </fieldset>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-3">
                    <asp:DropDownList ID="ddlFiltrarRol"   runat="server" CssClass="form-control" OnDataBound="ddlFiltrarCampus_DataBound"></asp:DropDownList>
                </div>
                <div class="col-md-1">
                    <label>Menú</label>
                </div>
                <div class="col-md-2">
                    <asp:TextBox runat="server" ID="txtfiltarMenu" CssClass="form-control" placeholder="Mi Menú"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    <label>Pantalla</label>
                </div>
                <div class="col-md-2">
                    <asp:TextBox runat="server" ID="txtfiltraPantalla" CssClass="form-control" placeholder="Mi Pantalla"></asp:TextBox>
                </div>
                <div class="col-md-1">
                    <asp:Button runat="server" ID="btnfiltrar" CssClass="btn btn-primary" OnClientClick="quitarValidar();" Text="Filtrar" OnClick="btnfiltrar_Click1" />
                </div>
            </div>
        </div>
            <div class="row table-condensed">
               <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
                   <asp:Panel runat="server" CssClass="hscrollbar" ID="pnlxxxs">
                       <asp:GridView ID="gvistasRolesmenus" PageSize="20" AllowPaging="true" DataKeyNames="id_menu_rol" CssClass="table" Width="100%" AutoGenerateColumns="false" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="GvPermisos_roles_PageIndexChanging">
                           <AlternatingRowStyle BackColor="White" ForeColor="#284775"></AlternatingRowStyle>
                           <Columns>
                               <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" DataField="id_menu_rol" HeaderText="id_menu" SortExpression="id_menu" Visible="false" />
                               <asp:BoundField ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" DataField="Rol" HeaderText="Rol" SortExpression="das"></asp:BoundField>
                               <asp:BoundField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-left" DataField="Menus" HeaderText="Menú" SortExpression="das"></asp:BoundField>
                               <asp:BoundField ItemStyle-CssClass="text-left" HeaderStyle-CssClass="text-left" DataField="Pantalla" HeaderText="Pantalla" SortExpression="das"></asp:BoundField>
                               <asp:TemplateField HeaderText="Eliminar" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center">
                                   <ItemTemplate>
                                       <asp:ImageButton ID="imbEliminar" CommandArgument='<%# Eval("id_menu_rol") %>' runat="server" ImageUrl="~/images/EliminarR.png" OnClick="imbEliminar_click" />
