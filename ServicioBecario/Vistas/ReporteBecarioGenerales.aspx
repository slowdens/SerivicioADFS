<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/Site1.Master" AutoEventWireup="true" CodeBehind="ReporteBecarioGenerales.aspx.cs" Inherits="ServicioBecario.Vistas.ReporteBecarioGenerales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1><label>Reportes de becarios</label></h1>
            <hr />
        </div>
    </div>
    <div class="jumbotron">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <asp:DropDownList runat="server" ID="ddlevaluados" CssClass="form-control" OnDataBound="ddlevaluados_DataBound"></asp:DropDownList>
                    </div>
                    <div class="col-md-3">
                        <asp:CheckBox runat="server" Text="No han sido evaluados" ID="chkNoEvaluados" />
                    </div>
                    <div class="col-md-1">
            ...
            <asp:Panel ID="pnldatos" runat="server" CssClass="hscrollbar">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="gvDatos" AllowPaging="True" AutoGenerateColumns="false" CssClass="table" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="gvDatos_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Alumno" HeaderText="Alumno becario" SortExpression="Alumno" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ></asp:BoundField>
                                ...
                                <asp:BoundField DataField="Programa" HeaderText="Programa academico" SortExpression="Programa" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center"></asp:BoundField>
                                ...
                                <asp:BoundField DataField="Evaluacion" HeaderText="Evaluacion" SortExpression="Evaluacion" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center"></asp:BoundField>
                            </Columns>
                    ...
                    <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="btnimgnDescargar" />
                    </Triggers>
                </asp:UpdatePanel>
            </asp:Panel>
        </div>
