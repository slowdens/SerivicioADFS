...
public static partial class TokenHelper
{
    ...
    public static string GetClaimUserwithTrustedLoginProvider(string ClaimUser)
    {
        string user = "i:0e.t|" + TrustedProviderName.ToLower() + "|" + ClaimUser;
        return user;
    }
    ...
    public static string GetClaimUserValue(IPrincipal principal, TokenHelper.IdentityClaimType claimType)
    {

        ClaimsUserIdClaim ClaimUserContext = TokenHelper.RetrieveIdentityForSamlClaimsUser(principal, claimType);
        return ClaimUserContext.ClaimsIdClaimValue;
    }
    #endregion
